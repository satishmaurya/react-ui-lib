...
var StyledTable = (0, _styledComponents.default)(_Table.default).withConfig({
  ...
  return props.size === "xs" ? (0, _styledComponents.css)(["height:.15rem;background:red;"]) : props.size === "sm" ? (0, _styledComponents.css)(["height:.30rem;"]) : props.size === "md" ? (0, _styledComponents.css)(["height:.50rem;"]) : props.size === "lg" ? (0, _styledComponents.css)(["height:2rem;"]) : (0, _styledComponents.css)(["height:1rem;"]);
});
