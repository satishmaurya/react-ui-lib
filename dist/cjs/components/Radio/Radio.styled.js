...
var StyledRadio = _styledComponents.default.div.withConfig({
  ...
  return props.error ? (0, _styledComponents.css)(["  & .radio-btn input:checked ~ .radio-check{background-color:#b67680d1;}& .radio-btn .radio-check:after{background:rgb(181,39,29);}& .radio-check{background-color:#ef5b5b;}& .radio-btn:hover input ~ .radio-check{background-color:#ef5b5b;}& label{color:#cc2424;}"]) : (0, _styledComponents.css)([""]);
});
