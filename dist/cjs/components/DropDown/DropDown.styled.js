...
${props => props.disabled ? css`
        ...
        cursor: pointer;
        `}
${props => props.type === "outlined" ? css`
        background: ${variable.white};
    ` : css`
    `}
${props => props.type === "outlined" && props.varient === "primary" ? css`
        varient: ${variable.blue};
    ` : props.type === "outlined" && props.varient === "secondary" ? css`
        varient: ${variable.gray600};
    ` : props.type === "outlined" && props.varient === "success" ? css`
        varient: ${variable.green};
    ` : props.type === "outlined" && props.varient === "info" ? css`
        varient: ${variable.cyan};
    ` : props.type === "outlined" && props.varient === "warning" ? css`
        varient: ${variable.yellow};
    ` : props.type === "outlined" && props.varient === "danger" ? css`
        varient: ${variable.orange};
    ` : props.type === "outlined" && props.varient === "purple" ? css`
        varient: ${variable.purple};
    ` : props.type === "outlined" && props.varient === "light" ? css`
        varient: ${variable.gray100};
    ` : props.type === "outlined" && props.varient === "dark" ? css`
...
` : css`
`}
${props => props.Iconsize === "sm" ? css`
    font-size: 12px;
    ` : props.Iconsize === "md" ? css`
    font-size: 14px;
    ` : props.Iconsize === "lg" ? css`
    font-size: 16px;
    ` : css`
    `}
svg{
